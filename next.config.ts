...
const nextConfig: NextConfig = {
  ...
  // mammoth converts .docx on the server only; it reaches for Node's zlib and
  // stream internals, which the bundler mangles.
  serverExternalPackages: ["@prisma/adapter-pg", "pg", "@react-pdf/renderer", "mammoth"],
